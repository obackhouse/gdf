...
def allow_single_kpt(output_is_kpts=False):
    """
    Decorate functions to allow `kpts` arguments to be passed as a
    single k-point.

    Parameters
    ----------
    output_is_kpts : bool, optional
        If `True`, the output of the decorated function is/are
        k-point(s). Default value is `False`.
    """
